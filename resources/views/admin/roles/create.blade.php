				...
				<div class="container-fluid">
					<div class="inner-body">		
						...
						<div class="page-header">
							<div>
								<h2 class="main-content-title tx-24 mg-b-5">Add Role</h2>
								<ol class="breadcrumb">
							...
							<div class="col-lg-12 col-md-12">
								<div class="card custom-card">
									<div class="card-body accordion-wizard">
										...
										<form  name="submit" action="{{route('role.store')}}" method="Post">
										  @csrf
											<div class="list-group">
												<div class="list-group-item py-4" data-acc-step>
													...
													<div data-acc-content>
													  ...
													  <div class="form-group col-md-8">
														...
														<div class="selectgroup selectgroup-pills">
															...
															<label class="selectgroup-item d-flex justify-content-around">
																<input type="checkbox" name="permission[]" value="{{$permission->id}}" class="selectgroup-input">
													  ...
													  <div class="mg-t-30">
														<button class="btn ripple btn-primary pd-x-20 btn-block w-25" type="submit">Add</button>
													</div>
													</div>
												</div>										
											</div>
